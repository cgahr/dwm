...
static const char *fonts[]          = { "Ubunut Mono NerdFont:size=10" };
static const char dmenufont[]       = "Ubunut Mono NerdFont:size=10";
...
static const char *dmenucmd[] = { "dmenu_run", "-m", dmenumon, "-fn", dmenufont, "-nb", col_background, "-nf", col_foreground, "-sb", col_selection_b, "-sf", col_foreground, NULL };
...
static const char *music_play[] = { "playerctl", "play-pause", NULL };
